...
class PolynomialTrajectory(genpy.Message):
  _md5sum = "06a047ee7f31cec40d869bbfb75ba273"
...
"""
  ...
  __slots__ = ['header','trajectory_id','action','num_order','num_segment','start_yaw','final_yaw','coef_x','coef_y','coef_z','time','mag_coeff','order','occ_state','debug_info']
  _slot_types = ['std_msgs/Header','uint32','uint32','uint32','uint32','float64','float64','float64[]','float64[]','float64[]','float64[]','float64','uint32[]','uint32','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,trajectory_id,action,num_order,num_segment,start_yaw,final_yaw,coef_x,coef_y,coef_z,time,mag_coeff,order,occ_state,debug_info
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.occ_state,) = _get_struct_I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
